...
Kids can **draw, erase, fill colors, adjust brush sizes, play animations, and even save unfinished projects to continue later**. ATAP makes animation accessible to everyone! 🎨✨  
...
2. **Install system dependencies**:
   ```bash
   sudo apt install python3-pyqt5 python3-venv
   ```
